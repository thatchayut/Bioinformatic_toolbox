...
def main():
    ...
    row_to_read_file_cal_gene_tscore = 100
    ...
    col_to_read_file_cal_gene_tscore_relapse.extend(list_sample_relapse)

    col_to_read_file_cal_gene_tscore_no_relapse = ["ID_REF"]
    col_to_read_file_cal_gene_tscore_no_relapse.extend(list_sample_no_relapse)
    ...
    # get gene expression of both classes
    print()
    ...
    for line_index in range(0, row_to_read_file_cal_gene_tscore):
        ...
        for element in file_to_cal_gene_tscore.iloc[line_index, 1:-1]:
                list_gene_expression_same_probe_id.append(element)  

        gene_probe_id = file_to_cal_gene_tscore.iloc[line_index, 0]
    ...
    # create collections of samples with their pathways' activity
        ...
        if (check_valid == True):
            for chunk_test_index in range(0, num_of_chunks):
                ...
                if (second_check_valid is True):
                    ...
                    # print("list_marker_evaluation_relapse : " + str(list_marker_evaluation_relapse))
                    ...
                    # print("list_marker_evaluation_no_relapse : " + str(list_marker_evaluation_no_relapse))
                    ...
                    for sample_index in range(0, len(list_marker_evaluation_relapse)):
                        ...
                        for top_ranked_pathway in list_top_rank_pathway_name:
                            for pathway_index in range(0, len(samples_relapse_pathway_activity[sample_index_in_list][1])):
                                ...
                                if (pathway_name == top_ranked_pathway):
