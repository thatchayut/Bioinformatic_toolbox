...
def main():
    print()
    print("------------------------------------------------------------------------------------------------------------------------")
    print(" # GSE3494 Sample to Class Mapper")
    print(" # Purpose : This program is used to match samples of dataset GSE3494 with their class.")
    print(" # You have to manually configure in gse3494_sample_to_class_mapper.py as follows")
    print(" #   [1] file_gene_expression_name : A file contains mapping between samples and their gene expression") 
    print(" #   [2] row_to_read_file_gene_expression : Number of rows in the file mapping between samples and their gene expression to be read")  
    print(" #   [3] file_mapping_sample_name : A file contains mapping between samples in 2 formats") 
    print(" #   [4] row_to_read_file_mapping_sample : Number of rows in the file contains mapping between samples in 2 formats to be read")  
    print(" #   [6] file_sample_status_name : A file contains mapping between samples and their class")  
    print(" #   [7] row_to_read_file_sample_status : Number of rows in the file contains mapping between samples and their class to be read")  
